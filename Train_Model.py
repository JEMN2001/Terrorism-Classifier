...
dump(most_common_words,"Trained_Model/BagOfWords.joblib")
DICT_SIZE = 5000
...
print("My bag of Words transformation done and saved!")
...
def tfidf_features(X_train, X_val):
    ...
    #save tfidf_features for post cleanings
    dump(tfidf_vectorizer, 'Trained_Model/tfidf_vectorizer.joblib')
...
print("TFIDF transformation done and saved!")
...
dump(mlb,"Trained_Model/MultiLabelBinarizer.joblib")
tags_val = mlb.fit_transform([[tag] for tag in tags_val])

print("The MultiLabelBinarizer is done and saved!")
...
dump(classifier_mybag, 'Trained_Model/Mybag_model.joblib')
dump(classifier_tfidf, 'Trained_Model/Tfidf_model.joblib')
